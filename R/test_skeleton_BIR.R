...
#   expect_equal(head(file1$uniqueID), c("", "", "",
#                                                "", "", ""))
#   expect_equal(tail(file1$uniqueID), c("", "", "",
#                                                "", "", ""))
#
#   expect_equal(head(file2$uniqueID), c("", "", "",
#                                                "", "", ""))
#   expect_equal(tail(file2$uniqueID), c("", "", "",
#                                                "", "", ""))
#
#   expect_equal(head(file3$uniqueID), c("", "", "",
#                                              "", "", ""))
#   expect_equal(tail(file3$uniqueID), c("", "", "",
#                                                "", "", ""))
#
#   expect_equal(head(file4$uniqueID), c("", "", "",
#                                                "", "", ""))
#   expect_equal(tail(file4$uniqueID), c("", "", "",
#                                                "", "", ""))
#
#   expect_equal(head(file5$uniqueID), c("", "", "",
#                                                "", "", ""))
#   expect_equal(tail(file5$uniqueID), c("", "", "",
#                                                "", "", ""))
# })
#
# test_that("voter number in right order", {
#   expect_equal(head(file1$voter_record), c(, , , , , ))
#   expect_equal(tail(file1$voter_record), c(, , , , , ))
#
#   expect_equal(head(file2$voter_record), c(, , , , , ))
#   expect_equal(tail(file2$voter_record), c(, , , , , ))
#
#   expect_equal(head(file3$voter_record), c(, , , , , ))
#   expect_equal(tail(file3$voter_record), c(, , , , , ))
#
#   expect_equal(head(file4$voter_record), c(, , , , , ))
#   expect_equal(tail(file4$voter_record), c(, , , , , ))
#
#   expect_equal(head(file5$voter_record), c(, , , , , ))
#   expect_equal(tail(file5$voter_record), c(, , , , , ))
# })
#
#
#
