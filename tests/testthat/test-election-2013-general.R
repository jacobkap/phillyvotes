...
test_that("right file name", {
  ...
  expect_equal(unique(file2$file), "2013 General 2 of 7 BIR")
  expect_equal(unique(file3$file), "2013 General 3 of 7 BIR")
...
test_that("unique voters have correct number of files recorded", {
  ...
  expect_equal(nrow(file2[file2$uniqueID == "022903 32",]), 3)
  ...
  expect_equal(nrow(file4[file4$uniqueID == "023420 20",]), 14)
  expect_equal(nrow(file4[file4$uniqueID == "023340 58",]), 9)
  expect_equal(nrow(file4[file4$uniqueID == "023340 59",]), 2)
  expect_equal(nrow(file4[file4$uniqueID == "023340 64",]), 6)
  expect_equal(nrow(file5[file5$uniqueID == "020214 1",]), 13)
  expect_equal(nrow(file5[file5$uniqueID == "023340 63",]), 8)
  expect_equal(nrow(file5[file5$uniqueID == "023340 64",]), 6)
  expect_equal(nrow(file5[file5$uniqueID == "023340 65",]), 32)
...
test_that("ballot ballot_position values are correct", {
  ...
  # First voter
  expect_equal(file5$ballot_position[1:13], c("4C", "7C", "8C", "20C",
                                              "8D", "9D", "10D", "11D",
                                              "14D", "15D", "16D", "17D",
                                              "7E"))
  # Second voter
  expect_equal(file5$ballot_position[14:36], c("37C", "4D", "7D", "8D", "9D",
                                               "11D", "12D", "13D", "14D",
                                               "15D", "16D", "17D", "20D",
                                               "5I", "11I", "18I", "22I", "26I",
                                               "30I", "36I", "5J", "11J", "18J",
...
test_that("Candidate has right name", {
  ...
  expect_equal(file1$candidate[file1$uniqueID == "022940 88", ],
               c("Daniel A Alvarez", "Kenneth J Powell Jr", "Vic Stabile",
                 "Anne Marie Coyle", "Terrence J Tracy Jr"))
  expect_equal(file1$candidate[file1$uniqueID == "022940 84", ],
               c("Vic Stabile", "Terrence J Tracy Jr", "Castille Yes Si",
                 "Anne Marie Coyle", "Daniel A Alvarez", "Jenneth J Powell Jr"))
  ...
  expect_equal(file2$candidate[file2$uniqueID == "022869 11", ],
               c("Henry Lewandowski", "Alan Butkovitz", "Daniel A Alvarez",
                 "Castille Yes Si", "Mccaffery Daniel D"))
  expect_equal(file2$candidate[file2$uniqueID == "022869 24", ],
               c("No No", "Daniel A Alvarez", "Castille Yes Si",
                 "Baer Yes Si", "Panella Yes Si", "Terrence J Tracy Jr",
                 "Gantman Yes Si"))
  expect_equal(file2$candidate[file2$uniqueID == "022903 31", ],
               c("Daniel A Alvarez", "Terrence J Tracy Jr",
                 "Vic Stabile", "Kenneth J Jr Powell",
                 "Anne Marie Coyle"))
  expect_equal(file2$candidate[file2$uniqueID == "022903 32", ],
               c("Gantman Yes Si", "Vic Stabile", "Castille Yes Si"))
  expect_equal(file3$candidate[file3$uniqueID == "020001 2", ],
               c("Terrence J Tracy Jr", "Castille No No", "Yes Si"))
  expect_equal(file3$candidate[file3$uniqueID == "023295 39", ],
               c("Yes Si", "R Seth Williams", "Castille Yes Si",
                 "O Keefe Yes Si", "O Neill Yes Si"))
  expect_equal(file3$candidate[file3$uniqueID == "023295 40", ],
               c("Anne Marie Coyle", "No No", "John Kilbride",
                 "Theresa Olsen", "Terrence J Tracy Jr", "Kenneth J Powell Jr",
                 "Daniel A Alvarez"))
  expect_equal(file3$candidate[file3$uniqueID == "021525 1", ],
               c("Sierra Thomas Street", "R Seth Williams",
                 "Jack Mcvay Jr", "Yes Si", "Alan Butkovitz"))
  ...
  expect_equal(file4$candidate[file4$uniqueID == "020644 15", ],
               c("Castille Yes Si", "Gantman Yes Si",
                 "Baer Yes Si", "R Seth Williams", "Yes Si",
                 "Alan Butkovitz", "Panella Yes Si"))
  expect_equal(file4$candidate[file4$uniqueID == "020643 51", ],
               c("R Seth Williams", "Alan Butkovitz", "Castille Yes Si"))
  expect_equal(file4$candidate[file4$uniqueID == "020860 1", ],
               c("Daniel A Alvarez", "Terrence J Tracy Jr",
                 "Kenneth J Powell Jr", "Anne Marie Coyle",
                 "Vic Stabile", "No No"))
  expect_equal(file5$candidate[file5$uniqueID == "022292", ],
               c("Jack Mcvay Jr", "R Seth Williams"))
  expect_equal(file5$candidate[file5$uniqueID == "023443 9", ],
               c("Jack Mcvay Jr", "Anne Marie Coyle",
                 "Daniel D Mccaffery", "J Scott O Keefe",
                 "Kenry Lewandoski", "R Seth Williams",
                 "Alan Butkovitz", "Tiffany Bradley",
                 "Tiffany Bradley", "Castille Yes Si",
                 "Panella Yes Si", "Brinkley Yes Si"))
  expect_equal(file5$candidate[file5$uniqueID == "022288 6", ],
               c("Sierra Thomas Street", "R Seth Williams",
                 "Tiffany Bradley", "Tiffany Bradley",
                 "Frazier Lyde Yes Si"))
  expect_equal(file5$candidate[file5$uniqueID == "022288 1", ],
               c("Allen Yes Si", "Ford Yes Si", "Deni Yes Si",
                 "Castille Yes Si", "Panella Yes Si",
                 "Wright Padilla Yes Si", "Patrick Yes Si"))
...
test_that("Categories are correct", {
  ...
  expect_equal(file1$category[file1$uniqueID == "020016 2", ],
               c("Judge of the Court of Common Pleas", "Judge of the Municipal Court"))
  expect_equal(file1$category[file1$uniqueID == "021641 26", ],
               c(NA))
  ...
  expect_equal(file2$category[file2$uniqueID == "022869 24", ],
               c("City Bond Question", "District Attorney",
                 ...
                 "Controller",
                 "Retention - Judge of the Superior Court - Susan Peika Gant"))
  expect_equal(file2$category[file2$uniqueID == "022903 31", ],
               c("District Attorney", "Controller", "Judge of the Superior Court",
                 "Judge of the Court of Common Pleas",
                 "Judge of the Court of Common Pleas"))
  expect_equal(file2$category[file2$uniqueID == "022903 32", ],
               c("Retention - Judge of the Superior Court - Susan Peika Gant",
  ...
  expect_equal(file3$category[file3$uniqueID == "023295 39", ],
               c("City Bond Question", "District Attorney",
                 "Retention - Justice of the Supreme Court - Ronald D Castille",
                 "Retention - Judge of the Court of Common Pleas - Joseph D O",
  ...
  expect_equal(file5$category[file5$uniqueID == "022288 1", ],
               c("Retention - Judge of the Court of Common Pleas - Jacquelin",
                 ...
                 "Retention - Judge of the Supreme Court - Ronald D Castille",
                 "Retention - Judge of the Superior Court - Jack Panella",
...
test_that("unique IDs in right order", {
  expect_equal(unique(head(file1$uniqueID)), c("020016", "020016", "020016",
                                               "020016", "020016", "020016"))
  expect_equal(unique(tail(file1$uniqueID)), c("022940", "022940", "022940",
                                               "022940", "022940", "022940"))

  expect_equal(unique(head(file2$uniqueID)), c("022721", "022721", "022721",
                                               "022721", "022721", "022721"))
  expect_equal(unique(tail(file2$uniqueID)), c("023374", "023374", "023374",
                                               "023374", "023374", "023374"))

  expect_equal(unique(head(file3$uniqueID)), c("020001", "020001", "020001",
                                               "020001", "020001", "020001"))
  expect_equal(unique(tail(file3$uniqueID)), c("021092", "021092", "021092",
                                               "021092", "021092", "021092"))

  expect_equal(unique(head(file4$uniqueID)), c("020323", "020323", "020323",
                                               "020323", "020323", "020323"))
  expect_equal(unique(tail(file4$uniqueID)), c("020860", "020860", "020860",
                                               "020860", "020860", "020860"))

  expect_equal(unique(head(file5$uniqueID)), c("020214", "020214", "020214",
                                               "020214", "020214", "020214"))
  expect_equal(unique(tail(file5$uniqueID)), c("023340", "023340", "023340",
                                               "023340", "023340", "023340"))
})
